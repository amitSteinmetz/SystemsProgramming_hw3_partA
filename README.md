...
### **This repository is about testing the fraction class:**

Fraction is a class that represents a fraction of two integers. the class has the following Overloaded operators:
